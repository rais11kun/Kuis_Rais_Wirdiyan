    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('pelanggan.create')}}">Mahasiswa</a></li>
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="{{ route('mahasiswa.index') }}" class="btn btn-primary"><i class="far fa-question-circle me-1"></i> Kembali</a>
            </div>
        </div>
    </div>
